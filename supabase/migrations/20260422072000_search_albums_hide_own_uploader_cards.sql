-- Keep public/followed album discovery open, but do not show the viewer's own
-- uploaded album cards in the Search > Albums surface. Albums from other users
-- inside the viewer's club/event remain visible when their surface flags allow it.
