-- Album search is a public album-card surface, not only "new account"
-- discovery. Keep own public and own-club public album cards visible too;
-- privacy, block filtering, and explicit album surface flags still decide
-- whether a card can be exposed.
