-- Keep notification push dispatch alive through edge cold starts and transient
-- network latency so inserts do not fall back to slow client-side sync loops.
