# UniVerse — Reklam Yaratıcı Brief'leri

**Kural:** Her hook, bir `claims-register.md` satırına bağlıdır. Sahte testimonial, sahte UGC, sahte sosyal kanıt üretilmez.
...
## Açı 1 — "Duyuru koridorda kalıyor"

**Kime:** Segment A (yeni gelen öğrenci)
**Claim:** F-03, F-04
**İçgörü:** Etkinlik duyurusu afişte, story'de ve grup sohbetinde dağılıyor; üçü de 24 saatte kayboluyor. Sorun ilgisizlik değil, **kalıcı bir liste olmaması**.
...
**Kanal:** Instagram Reels, TikTok, üniversite topluluk sayfaları
**Ölçülecek:** 3sn izleme oranı → tıklama → store sayfası → kurulum → `first_value_discovery`
**Yasak:** "Herkes orada, sen yoksun." · Katılımcı sayısı göstermek. · Gerçek kulüp adı kullanmak.

---

## Açı 2 — "Kulübün duyurusu bir yerde dursun"

**Kime:** Segment B (kulüp yöneticisi)
**Claim:** F-04, F-05, F-06
**İçgörü:** Kulüp yöneticisi aynı duyuruyu 3–4 kanala ayrı ayrı yazıyor; katılımı tahmin ediyor; etkinlik fotoğrafları sonradan kimsenin bulamadığı bir yerde kalıyor.
...
**CTA:** `Kulüp hesabı aç.`
**Kanal:** Kulüp yöneticilerinin bulunduğu topluluk grupları, kampüs LinkedIn/Instagram sayfaları
**Ölçülecek:** tıklama → kurulum → kulüp hesabı kaydı → `first_value_publish`
**Yasak:** "Katılımı %X artırır." (M-03) · "Tüm kulüpler kullanıyor." (M-01)

---

## Açı 3 — "İzin listesini oku"

**Kime:** Segment A ve C; ayrıca öğrenci velisi/karar vericisi
**Claim:** P-01, P-02, P-03, P-04
**İçgörü:** Kampüs uygulamalarında konum izni beklenen bir şey. İstememek, store'un izin listesinden **doğrulanabilen** bir farktır. Bu, kanıtı reklamın dışında olan tek mesajımız.
...
Tek kare: solda dört izin ikonu, sağda üstü çizili konum ikonu.
**Metin:** `Kampüs uygulaması. Konum izni yok.`

**Caption:** `Kampüs bağlamı üniversite bilgisinden gelir; konumundan değil.`
**CTA:** `İzin listesini kendin gör.`
**Kanal:** Organik paylaşım, gizlilik odaklı topluluklar, store sayfası promosyon metni
**Ölçülecek:** store sayfası görüntüleme → kurulum dönüşümü (bu açının etkisi en net store sayfasında görünür)
**Yasak:** "Hiçbir veri toplamıyoruz." (P-01 yasak sütunu) · Rakibin izin listesini gösterip karalamak.

---

## Düşük bütçeli organik dağıtım
...
Hiçbir açı için "kazandı" denmez; şu üçü sağlanmadan karar verilmez:

1. Açı başına en az 1.000 store sayfası görüntülemesi,
2. Kurulum sonrası en az 7 günlük gözlem,
3. Kurulum artışının `first_value_*` olayını da artırdığının görülmesi.

Kurulum artıp `first_value_*` düşüyorsa creative yanlış beklenti yaratıyordur; kazanan sayılmaz ve metni düzeltilir.
